...
//
//  Created by Darrick  on 12/15/23.
//
...
main ()
{
  ...
  int meal_cost = 0, desert_cost = 0;
    ...
    cout<<setw(56) <<left << "Welcome to Discovery Bay Golf and Country Club Resturant" << left << setw(56) << endl;
    cout<<
    "|                  Meal                  |           Price          |\n"
    <<
    "---------------------------------------------------------------------\n"
  ...
  float sales_tax = subtotal * 0.075, total = subtotal + sales_tax;
    ...
    //setprecision
    cout<< "Your subtotal is: " << subtotal <<setprecision(0)<<endl;
