...
// Define struct for birthday date
struct BirthdayDate {
    int month;
    int day;
    int year;
...
int main() {
    ...
    do {
        ...
        // Display meanings
        cout << "The month of " << getMonthMeaning(birthday.month) << endl;
        cout << "The " << birthday.day << getOrdinalSuffix(birthday.day) << " of the month means " << getDayMeaning(birthday.day) << endl;
        cout << "The year " << birthday.year << " means " << getYearMeaning(birthday.year) << endl;
...
string getYearMeaning(int year) {
    switch(year) {
        ...
        case 2004: return "Strong-Willed Intelliegnt, Creative, and Natural Born Leader";
        ...
        case 2007: return "Honest, Great Friend, Optimisitic, and Moody";
        ...
        case 2011: return "Senstive, Bored Easily, and Funny";
        case 2012: return "Impatient, Energetic, Smart, and Persistent";
        case 2013: return "Energetic, Self-Driven, Perisistent, and Polite";
        ...
        case 2019: return "Innovative, Loving, and Religous";
